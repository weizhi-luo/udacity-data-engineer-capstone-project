...
VARIABLE_KEY = 'rail_london_blackfriars_inbound_services'
HTTP_CONN_ID = 'national_rail_historical_service_performance'


with DAG(
    dag_id='daily_rail_london_blackfriars_inbound_'
           'services_performance_download',
    description='Daily national rail London Blackfriars inbound '
