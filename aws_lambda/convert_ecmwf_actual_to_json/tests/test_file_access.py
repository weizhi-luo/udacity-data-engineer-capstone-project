...
class TestGetXarrayDatasetFromFileOnS3(TestCase):
    ...
    def test_provide_file_path_file_opened(
            self, mock_xarray_open_dataset, _, __):
        s3_bucket = 'udacity-dend-capstone-project-weizhi-luo'
        s3_key = 'ecmwf-weather-actual/netcdf/2022-06-21.nc'
        file_path = '/tmp/2022-06-21.nc'

        get_xarray_dataset_from_file_on_s3(s3_bucket, s3_key)
