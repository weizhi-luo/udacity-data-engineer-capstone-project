...
def handler(event, context):
    ecmwf_file_s3_bucket, ecmwf_file_s3_key, engine, date, time, \
        ...
        event['engine'], event['date'], event['time'], \
    ...
    destination_s3_key = \
        create_s3_key_for_file(json_file, destination_s3_folder, time, date)
