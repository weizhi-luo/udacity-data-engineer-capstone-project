...
from file_tool import \
    create_s3_key_for_file, get_file_name_without_extension, \
...
class TestGetFileNameWithoutExtension(TestCase):
    def test_get_file_name_without_extension(self):
        file_path = r'ecmwf-weather-forecast/grib2/00/' \
                    r'2022-06-21/2022-06-21_00_10u.grib2'
        expected_file_name_without_extension = '2022-06-21_00_10u'
...
class TestChangeFileExtension(TestCase):
    def test_provide_file_name_with_extension_return_file_with_new_extension(
            self):
        file_name_with_extension = 'test.grib2'
        new_extension = 'json'
...
class TestCreateLocalFilePathFromS3Path(TestCase):
    def test_return_expected_local_path(self):
        file_s3_path = 'udacity-dend-capstone-project-weizhi-luo/' \
                       'ecmwf-weather-forecast/grib2/00/2022-06-27/' \
                       '2022-06-27_00_2t.grib2'
        expected_file_path = '/tmp/2022-06-27_00_2t.grib2'
